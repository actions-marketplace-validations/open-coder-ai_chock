# Generated by agentseam 0.3.1 -- bundle("antigravity"). Do not hand-edit, except the
...
def _decide(raw):
    ...
    try:
        ...
        # failure is printed for the operator and the gate answers deny in 'antigravity''s
